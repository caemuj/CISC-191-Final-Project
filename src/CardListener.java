...
public class CardListener implements ActionListener
{
	...
	public CardListener(Card linkedCard, Player playerDeck,
			EnemyField enemyField, JLabel manaTag)
	{
	...
	/**
	 * Handles event when the player clicks on their own card, allows them to
	 * either play the card or spend mana to attack with it if it is a creature
	 * on the field.
	 */
	@Override
	public void actionPerformed(ActionEvent e)
	{
		if (linkedCard instanceof SpellCard)
		{
			...
			playerDeck.draw(linkedCard.getDraw());
				...
				&& playerDeck.getMana() >= linkedCard.getCost())
		{
