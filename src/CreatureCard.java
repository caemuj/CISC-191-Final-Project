 ...
 * @version 1.0
 *          An extension of the Card class that contains data and methods
 *          specific to creature cards
 */
public class CreatureCard extends Card
{
	 ...
	 * 
	 * @param cardID An internal string representing the card's stats. The
	 *               standard format is "strength;cost"
	 */
	 ...
	 * 
	 * @return The creature's mana cost to attack
	 */
	@Override
	public int getCost()
	{
