...
public class EnemyField
{
	...
	/**
	 * A method to reset the enemy field and populate it with new enemies after
	 * the player has beaten all currently on field enemies.
	 * The strength and kinds of enemies generated are based on the player's
	 * score.
	 */
	public void reset()
	{
	...
	/**
	 * Method to handle the enemy attack phase, happens every time the player
	 * ends their turn.
	 */
	public void attack()
	{
	...
	/**
	 * Enables enemy cards for interaction allowing the player to target them
	 * for an attack
	 */
	...
	/**
	 * Disables enemy cards to prevent interaction after the player has made
	 * their attack
	 */
	...
	/**
	 * Method to destroy enemies that have been successfully attacked by the
	 * player and update the UI
	 * 
	...
	/**
	 * Checks whether or not all enemies have been defeated. Resets the enemy
	 * field and updates the UI if so.
	 */
