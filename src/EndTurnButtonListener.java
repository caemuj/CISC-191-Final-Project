...
public class EndTurnButtonListener implements ActionListener{
	 ...
	 * @param healthTag The JLabel responsible for displaying the player's health
	 ...
	 */
	public EndTurnButtonListener(GameGUI gui, EnemyField enemies, JLabel healthTag, Player deck, JPanel allyPanel, JLabel manaTag) {
	...
	/**
	 * Handles the end turn button being pressed. Causes enemies to attack, updates player health, draws a card, resets mana, and then updates the UI to visually display the changes.
	 */
	@Override
